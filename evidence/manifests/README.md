...
This directory contains hash-only provenance for reviewed private evidence and
public research files.

- numbered test manifests: Tests 03B, 04, 10, 14, 15, 16, and 17
...
- `stock-adb-toggle-evidence-hashes.txt` — hash-only r25.3.1.2/.3 source, private-analysis, HCI, and grammar provenance
