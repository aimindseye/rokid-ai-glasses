...
def classify(probes: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "schema": "rokid.r25.2.3.1.hci-preflight.v1",
        "status": status,
        "method": method,
...
def main() -> int:
    ...
    print(f"R25_2_3_1_HCI_PREFLIGHT_STATUS={result['status']}")
    print(f"R25_2_3_1_HCI_PREFLIGHT_METHOD={result['method']}")
    print(f"R25_2_3_1_HCI_CAPTURE_ALLOWED={'YES' if result['capture_allowed'] else 'NO'}")
