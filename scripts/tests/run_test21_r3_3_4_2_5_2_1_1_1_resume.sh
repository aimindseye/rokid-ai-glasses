...
CHECK="$REPO/scripts/tests/check_test21_r3_3_4_2_5_2_1_1_1_source_contract.py"
COLLECT="$REPO/scripts/tests/collect_test21_r3_3_4_2_5_2_1_1_1_persistent.py"
ANALYZE="$REPO/scripts/tests/analyze_test21_r3_3_4_2_5_2_1_1_1_bootstrap.py"
COL="$OUTPUT/private/external-memory-persistent-bootstrap"
mkdir -p "$COL" || exit 1

echo "============================================================"
echo "TEST 21 r3.3.4.2.5.2.1.1.1 — MAGISK NON-TTY PERSISTENT WORKER"
echo "============================================================"
echo "MODE=MAGISK_NON_TTY_PERSISTENT_WORKER_BOOTSTRAP_REPAIR"
echo "PERSISTENT_ROOT_TRANSPORT=ADB_SHELL_T"
echo "MAGISK_SU_COMMAND_MODE=SINGLE_QUOTED_SU_C"
echo "PERSISTENT_ROOT_SESSION_QUALIFICATION=REQUIRED_BEFORE_MEMORY"
...
COLLECT_RC=$?
[ "$COLLECT_RC" -eq 0 ] || { echo "ERROR: persistent-root bootstrap/census collection failed"; exit "$COLLECT_RC"; }
...
echo "TEST21_R3_3_4_2_5_2_1_1_1_RUN_RC=0"
echo "OUTPUT=$OUTPUT"
echo "PERSISTENT_ROOT_TRANSPORT=ADB_SHELL_T"
echo "PERSISTENT_ROOT_SESSION_QUALIFICATION=PASS"
