...
# compatibility-contract marker: parcel-marshalling.tsv
...
def main() -> int:
    ...
    print('SANITIZED_PACKAGE=' + str(out))
    print('SANITIZED_PACKAGE_SHA256=' + hashlib.sha256(out.read_bytes()).hexdigest())
    print('SANITIZED_FILE_COUNT=6')
    return 0
