...
# compatibility-contract marker: PRIVATE_JSON_INCLUDED=NO
...
def main() -> int:
    ...
    if rc != 0: return rc
    print('TEST21_R3_3_4_2_2_SANITIZED_PACKAGE=PASS')
    print('PRIVATE_JSON_INCLUDED=NO')
    print('RAW_APK_INCLUDED=NO')
