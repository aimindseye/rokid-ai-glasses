...
# compatibility-contract marker: COMPILED_FRIDA_AGENT_INCLUDED=NO
# compatibility-contract marker: FRIDA_JAVA_BRIDGE_PACKAGE_INCLUDED=NO
...
def main() -> int:
    ...
    if rc != 0: return rc
    print('TEST21_R3_3_4_2_5_1_SANITIZED_PACKAGE=PASS')
    print('RAW_PROCESS_MAPS_INCLUDED=NO')
    print('RAW_MEMORY_DEX_INCLUDED=NO')
    print('COMPILED_FRIDA_AGENT_INCLUDED=NO')
    print('FRIDA_JAVA_BRIDGE_PACKAGE_INCLUDED=NO')
    print('PRIVATE_RUNTIME_JSON_INCLUDED=NO')
