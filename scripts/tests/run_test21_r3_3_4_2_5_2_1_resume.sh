...
CHECK="$REPO/scripts/tests/check_test21_r3_3_4_2_5_2_1_source_contract.py"
COLLECT="$REPO/scripts/tests/collect_test21_r3_3_4_2_5_2_1_coverage.py"
ANALYZE="$REPO/scripts/tests/analyze_test21_r3_3_4_2_5_2_1_coverage.py"
COL="$OUTPUT/private/external-memory-coverage"
mkdir -p "$COL" || exit 1

echo "============================================================"
echo "TEST 21 r3.3.4.2.5.2.1 — PROC MEM COVERAGE REPAIR"
echo "============================================================"
echo "MODE=NON_INJECTED_ROOT_EXTERNAL_MEMORY_COVERAGE_REPAIR"
...
COLLECT_RC=$?
[ "$COLLECT_RC" -eq 0 ] || { echo "ERROR: coverage-repair collection failed"; exit "$COLLECT_RC"; }
...
echo "TEST21_R3_3_4_2_5_2_1_RUN_RC=0"
echo "OUTPUT=$OUTPUT"
