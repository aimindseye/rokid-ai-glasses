...
# compatibility-contract marker: RAW_PROCESS_MAPS_INCLUDED=NO
...
def main() -> int:
    ...
    if rc != 0: return rc
    print('TEST21_R3_3_4_2_3_SANITIZED_PACKAGE=PASS')
    print('RAW_DUMPSYS_INCLUDED=NO')
    print('RAW_PROCESS_MAPS_INCLUDED=NO')
    print('RAW_APK_JAR_DEX_INCLUDED=NO')
    print('DEVICE_SERIAL_INCLUDED=NO')
    print('ADB_READ_ONLY=YES')
