...
# compatibility-contract marker: APK_INCLUDED=NO
...
def main() -> int:
    ...
    if rc != 0: return rc
    print('TEST21_R3_3_4_2_1_SANITIZED_PACKAGE=PASS')
    print('APK_INCLUDED=NO')
    print('RAW_BYTECODE_INCLUDED=NO')
    print('REPO_SOURCE_INCLUDED=NO')
