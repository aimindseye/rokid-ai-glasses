...
# compatibility-contract marker: callback-transaction-map.tsv
# compatibility-contract marker: callback-parcel-marshalling.tsv
...
def main() -> int:
    ...
    print('SANITIZED_SUMMARY_ZIP=' + str(out))
    print('SANITIZED_SUMMARY_ZIP_SHA256=' + hashlib.sha256(out.read_bytes()).hexdigest())
    print('SANITIZED_SUMMARY_SIDECAR=' + str(side))
    return 0
