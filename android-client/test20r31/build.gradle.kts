...
android {
    namespace = "org.aimindseye.rokid.cxrmediapreflight"
    compileSdk = 36

    defaultConfig {
        applicationId = "org.aimindseye.rokid.cxrmediapreflight"
        minSdk = 31
        targetSdk = 36
        versionCode = 1
        versionName = "1.0-test20-r3.1"
    }
    ...
    object : org.gradle.api.Action<org.gradle.api.execution.TaskExecutionGraph> {
        override fun execute(graph: org.gradle.api.execution.TaskExecutionGraph) {
            ...
            if (selected && cxrLVersion != "1.0.1") {
                throw GradleException(
                    "Test 20 r3.1 is attested only for " +
