...
android {
    namespace = "org.aimindseye.rokid.cxreventqualification"
    compileSdk = 36

    defaultConfig {
        applicationId = "org.aimindseye.rokid.cxreventqualification"
        minSdk = 31
        targetSdk = 36
        versionCode = 1
        versionName = "1.0-test20-r2"
    }
    ...
    object : org.gradle.api.Action<org.gradle.api.execution.TaskExecutionGraph> {
        override fun execute(graph: org.gradle.api.execution.TaskExecutionGraph) {
            ...
            if (selected && cxrLVersion != "1.0.1") {
                throw GradleException(
                    "Test 20 r2 is attested only for " +
